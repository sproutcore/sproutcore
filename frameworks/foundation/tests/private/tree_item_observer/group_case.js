...
/*globals module, test, equals, ok, same, throws, should_throw */
...
test("contentIndexDisclosureState", function () {
  ...
  for (idx = 0; idx < len; ++idx) {
    ...
    equals(obs.contentIndexDisclosureState(null, obs, idx), expected,
        'obs.contentIndexDisclosureState(null, obs, %@) should eql %@'.fmt(idx, str));
  }
});
