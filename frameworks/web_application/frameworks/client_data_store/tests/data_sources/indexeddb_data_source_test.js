...
if (SC.platform.supportsIndexedDB) {
  module("SC.IndexedDBDataSource", {

    setup: function () {
      // Create the data source.
      dataSource = SC.IndexedDBDataSource.create({
  ...
  test("Method: createRecord", function () {
    ok(SC.IndexedDBDataSource.prototype.createRecord !== undefined, 'defined', 'defined', "The method is");
  ...
  test("Method: destroyRecord", function () {
    ok(SC.IndexedDBDataSource.prototype.destroyRecord !== undefined, 'defined', 'defined', "The method is");
  ...
  test("Method: fetch", function () {
    ok(SC.IndexedDBDataSource.prototype.fetch !== undefined, 'defined', 'defined', "The method is");
    ...
    dataSource.addObserver('isReady', function () {
      ...
      if (dataSource.get('isReady')) {
        ...
        // Insert a record.
        SC.IndexedDBAdaptor.insertRow(dataSource._sc_db, 'SC.Record', { stringProp: 'A' }, function (id1) {

          // Insert a record.
          SC.IndexedDBAdaptor.insertRow(dataSource._sc_db, 'SC.Record', { stringProp: 'B' }, function (id2) {
  ...
  test("Method: retrieveRecord", function () {
    ok(SC.IndexedDBDataSource.prototype.retrieveRecord !== undefined, 'defined', 'defined', "The method is");
  ...
  test("Method: updateRecord", function () {
    ok(SC.IndexedDBDataSource.prototype.updateRecord !== undefined, 'defined', 'defined', "The method is");
