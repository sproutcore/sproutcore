...
test("reading unmodified record from root store", function() {
  ...
  ok(!store.changedStoreKeys || (store.changedStoreKeys.indexOf(storeKey)<0), 'changedStoreKeys should not include storeKey since it has not technically changed yet');
});
