...
for (var userAgent in userAgents) {
  ...
  test(userAgent, function() {
    ...
    equals(browser.versionFloat(expected['version']), expected['versionFloat'], "'version' float should be '" + expected['versionFloat'] + "'");
  });
