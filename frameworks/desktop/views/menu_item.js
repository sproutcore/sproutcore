...
/** @scope SC.MenuItemView.prototype */{
  ...
  */
  ...
  /**
    This method is used to fetch the view to which the menu pane is anchored 
    to
  ...
  */
  ...
  /**
    Checks if a menu item has a sub menu.
  */
  hasSubMenu: function(){
    var content = this.get('content') ;
  ...
  /**
    This method will create the sub menufor a menu item if it has a sub menu
  */
  branching: function() {
