  ...
  VERTICAL_STACK: {
    ...
    shouldNotifyChildViewsOnParentLayoutChange: function (view) {
      ...
      if (view._previousLayout && currentLayout) {
        return ( view._previousLayout.width != currentLayout.width ) ||
               ( view._previousLayout.left != currentLayout.left ) ||
               ( view._previousLayout.right != currentLayout.right );
      }
    ...
    notifyChildViewsOnClippingFrameDidChange: function (view) {
      ...
      if (view._childViewsStartPositions &&
        ...
        if (len > 0) {
          ...
          var clippingStart = clippingFrame.y;
          var clippingEnd = clippingStart + clippingFrame.height;
          var idx = 0;
          var position;
