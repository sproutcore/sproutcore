...
SC.CoreStatechartManager = /** @scope SC.CoreStatechartManager.prototype */{
  ...
  */
  ...
  _executeGotoStateActions: function (gotoState, actions, marker, context) {
    ...
    for (; marker < len; marker += 1) {
      ...
      case SC.ENTER_STATE:
        this._enterState(action.state, action.currentState, context);
        break;
      }
    }
...
/**
  A Statechart class.
*/
SC.CoreStatechart = SC.Object.extend(SC.CoreStatechartManager, {
  autoInitStatechart: NO
});

SC.CoreStatechart.design = SC.CoreStatechart.extend;
