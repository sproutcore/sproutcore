...
test("if view has layout, calls _updatedLayout", function() {
	...
	view.updateLayout();
	equals(callCount, 0, 'should not call _updatedLayout() because the view isn\'t shown');

	view.updateLayout(true);
	equals(callCount, 1, 'should call _updatedLayout() because we force it');
