...
test("check initial statechart history states", function() {
  equals(statechart.get('rootSubstate').get('historyState'), statechart.getState('a'), 'root state\'s history state should be state a');
...
test("go to state b and check history states", function() {
  ...
  equals(statechart.get('rootSubstate').get('historyState'), statechart.getState('b'), 'root state\'s history state should be state b');
