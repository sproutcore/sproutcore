 ...
 * @extends SC.View
 */
MediaExamples.AudioView = SC.View
    .extend(
    /** @scope MediaExamples.AudioView.prototype */
    {
      ...
      mediaControlsContainer: SC.View
          .extend(
              SC.FlowedLayout,
              {
                ...
                childViews: ['audioPlayer', 'mediaControlsLabel', 'mediaControls', 'miniControlsLabel', 'miniControls',
                             'simpleControlsLabel', 'simpleControls'],
                
                audioPlayer: SC.AudioView
                    .extend({
