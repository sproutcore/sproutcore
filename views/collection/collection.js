...
/** @scope SC.CollectionView.prototype */
{
  ...
  */
  _flushZombieGroupViews: function() {
    ...
    // HACK? Go through and make sure that you actually removed all groups that are empty.
    if(this.get("groupBy"))
    {
      ...
      {
        if(this.childNodes[i] && this.childNodes[i].childNodes.length == 1 && this.childNodes[i].get("content") != null)
        {
