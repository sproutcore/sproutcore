...
var fws = ["frameworks/runtime"].map(function (f) { return pathlib.join(curdir, '..', f); });
...
var startUp = function () {
  ...
  runInContext("var window = this;", "lib/index.js_startUp");
...
module.exports = {
  ...
  // a set with getters and setters that allows external programs
